...
# 在文档末尾添加参考文献
content = content.rstrip() + references_section
...
print("2. Moved abstract to correct position")
print("3. Removed incorrect 1.4.2 section")
print("4. Added references section at the end")
