...
*注2（δ_team：≥0.3 SD 或 10%（工作假设，需跨领域/任务校准） SD 或 10%，工作假设），并需随领域/任务进行校准与敏感性分析。与I-AVP的Cohen's d ≥ 0.3 或 ≥10%（*working assumption*）口径一致。*
...
| **拔线窗口**     | W          | 4-8周（默认6周）<br>（工作假设，需跨领域/任务校准）    | 能力巩固的经验性时间窗口   | 快速技能4周；<br>复杂技能8-12周；<br>长期学习12-24周         |
...
| **W窗口**         | 4-8周（默认6周）<br>（工作假设，需跨领域/任务校准）     | 3.0.2节  | 3.0.2节  | 3.1/4.1/附录A   |
